...
public class HighScoresPicture extends Entity implements Updatable {
	...
	public HighScoresPicture(){
		...
		fgg.drawString("Franco      1000000", 20, 100);
		fgg.drawString("Ema          140032", 20, 120);
		fgg.drawString("Michel        43030", 20, 140);
		fgg.drawString("Simone          280", 20, 160);
