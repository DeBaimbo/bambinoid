...
public class StartPicture extends Entity implements Updatable {
	...
	public StartPicture(){
		Main.log("StartPicture constructor");
		setWidth(Main.WIDTH);
		...
		fgg.drawString("space to start",20,100);
	...
	public void update(){
		...
		if(Keyboard.INSTANCE.getKeyState(Keyboard.Key.SPACE)){
			...
			EntityManager.INSTANCE.restartLevel();
			return;
		}
	}
